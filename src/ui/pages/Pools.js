...
const PoolTable = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'price',
            render: (price) => (
                <p>{formatUSD(price, context.vetherPrice)}</p>
            )
        },
        {
            title: 'Depth',
            ...
            key: 'depth',
            render: (depth) => (
                <p>{formatUSD(convertFromWei(depth), context.vetherPrice)}</p>
            )
        },
        {
            title: 'Volume',
            ...
            key: 'volume',
            render: (volume) => (
                <p>{formatUSD(convertFromWei(volume), context.vetherPrice)}</p>
            )
        },
        {
            title: 'TX Count',
        ...
        },
        {
            ...
            key: 'fees',
            render: (fees) => (
                <p>{formatUSD(convertFromWei(fees), context.vetherPrice)}</p>
            )
        },
        {
            render: (record) => (
